...
exports.Hamming_distance=function(hash1,hash2){
    if(util.isNumberCharacterSequence(hash1)&&util.isNumberCharacterSequence(hash2)) {
        return the_exact_module.Hamming_distance(hash1, hash2);
    }else{
        throw new Error("Please do not change the type of hash value,it should be a String number for veracity and with no letter");
    }
}
